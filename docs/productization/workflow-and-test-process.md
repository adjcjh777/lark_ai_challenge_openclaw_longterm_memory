...
`check_real_feishu_expression_quality_gate.py` 是 pre-live 本地质量 gate；当前已通过脱敏样本硬阈值，但只能证明 sanitized fixture 的上线前质量门禁，不是真实 Feishu live evidence 或 productized live 证明。
