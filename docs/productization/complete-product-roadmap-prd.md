...
**Contract artifacts**（可单独建文件，也可先内嵌在本 PRD/test spec；若内嵌，位置如下）：
- `storage-contract.md`：本 PRD 第 6.1 节。
- `permission-contract.md`：本 PRD 第 6.2-6.4 节。
- `openclaw-payload-contract.md`：本 PRD 第 6.5 节。
- `audit-observability-contract.md`：本 PRD 第 6.6 节。
- `migration-rfc.md`：本 PRD 第 7 节。
- `negative-permission-test-plan.md`：测试规格第 4 节。
...
```json
{
  "allowed": true,
  "decision": "allow",
  "reason_code": "same_organization_visible_team",
