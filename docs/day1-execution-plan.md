...
1. **定架构边界**：明确 P0 做什么、不做什么，避免两人团队被飞书 API、H5、OpenClaw、评测、白皮书同时拉散。
...
- 队友晚上能基于文档独立产出测试集和 Demo 文案，不阻塞主线开发。
