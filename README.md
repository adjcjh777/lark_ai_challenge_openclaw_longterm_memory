...
| P1 | 扩大真实表达 pre-live 质量 gate | `scripts/check_real_feishu_expression_quality_gate.py --json` 已通过本地硬 gate：Recall@3 0.8750、误记率 0.0000、误提醒率 0.0000、解释覆盖率 1.0000、旧值泄漏率 0.0000；仍保留含糊上下文失败样例，不能说生产真实用户稳定可用 |
