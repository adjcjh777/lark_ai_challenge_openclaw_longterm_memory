...
| P1 | 补 workspace source coverage collector | 已新增 `collect_workspace_source_coverage_evidence.py`，从已有脱敏 evidence reports 归一化 source coverage patch；2026-05-04 最新非示例 partial manifest 已让 source adapter、workspace surface、same-conclusion 和 conflict-negative 子项全部通过，后续 blocker 已收敛到 24h+ long-run |
