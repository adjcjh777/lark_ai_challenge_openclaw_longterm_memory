...
| P1 | 修复真实表达 pre-live 质量 gate | `scripts/check_real_feishu_expression_quality_gate.py --json` 已把脱敏真实表达 benchmark 变成硬 gate；当前 Recall@3、误记率、误提醒率、解释覆盖率通过，但旧值泄漏率 0.1429 未达 0.0000，因此 UX-06 只能说样本/runner 已完成，不能说真实表达质量已达上线前门禁 |
