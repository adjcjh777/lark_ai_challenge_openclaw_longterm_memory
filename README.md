...
如果你要继续做 workspace 方向，先看 `docs/productization/workspace-ingestion-goal-completion-audit-2026-05-04.md`、`docs/productization/workspace-ingestion-architecture-adr.md` 和 `docs/productization/workspace-ingestion-evidence-collection-runbook.md`。如果你要做上线或评委材料，先看 `docs/productization/full-copilot-next-execution-doc.md` 和 `docs/productization/prd-completion-audit-and-gap-tasks.md`。
